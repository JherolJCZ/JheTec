          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {onRefreshCatalog && (
              <button
                ...
                disabled={isSyncing}
                className="flex items-center gap-1.5 px-3 py-2 sm:py-2.5 rounded-2xl bg-white/10 hover:bg-white/15 text-slate-100 hover:text-cyan-300 border border-white/15 shadow-xs transition-all active:scale-95 disabled:opacity-50 cursor-pointer text-xs font-semibold"
                title="Actualizar catálogo en vivo desde Google Drive"
              >
